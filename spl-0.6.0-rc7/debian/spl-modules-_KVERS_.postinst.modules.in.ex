#!/bin/sh
# postinst script for modules package built from spl
...
case "$1" in
    configure)
        ...
        modprobe spl-foo 2>/dev/null || modprobe spl-bar 2>/dev/null || true
        # start or restart after install or upgrade
		# Tests to see if the binary exists first
        if test -x /usr/sbin/spl ; then
		  invoke-rc.d spl start || true
        fi
    ;;
