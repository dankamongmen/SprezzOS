...
install() {
	...
	inst_rules /usr/lib/udev/rules.d/60-zpool.rules
	inst_rules /usr/lib/udev/rules.d/60-zvol.rules
	inst /etc/zfs/zdev.conf
	inst /etc/zfs/zpool.cache
	dracut_install /usr/sbin/zfs
	dracut_install /usr/sbin/zpool
	dracut_install /usr/bin/zpool_layout
	dracut_install /usr/lib/udev/zpool_id
