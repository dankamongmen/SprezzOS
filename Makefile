...
$(CHROOT)/$(DIDEB): $(CHROOT)/linux-$(UPSTREAM)/debian $(CHROOT)/$(UDKDIR)/MyWorkSpace/Conf/target.txt $(CHROOT)/$(UDKDIR)/refind/install.sh
	sudo chroot $(CHROOT) /$(BUILDIN) $(UPSTREAM) $(ZFSVER)

$(CHROOT)/$(UDKDIR)/refind/install.sh: $(CHROOT)/$(BUILDIN)
