#!/bin/sh
# postinst script for modules package built from zfs
...
case "$1" in
    configure)
        ...
        modprobe zfs-foo 2>/dev/null || modprobe zfs-bar 2>/dev/null || true
        # start or restart after install or upgrade
		# Tests to see if the binary exists first
        if test -x /usr/sbin/zfs ; then
		  invoke-rc.d zfs start || true
        fi
    ;;
